...
MDG = 'C:/Users/2095421/Downloads/Migration/GRD/MARA_M1P_Ext.xlsx'
ATLAS = 'C:/Users/2095421/Downloads/Migration/GRD/MARA_AAP_Ext.xlsx'
...
scope_df = pd.read_excel('C:/Users/2095421/Downloads/Migration/GRD/Field_Scope_Data_Migration.xlsx', sheet_name=TABLE)
...
for col_name in scope_field:
    ...
    for index in df2.index:
        ...
        if index in df1.index:
            ...
            # if (df2.loc[index, col_name]).equals(df1.loc[index, col_name]):
                # print(f'Key {index}: Yes')
                # result_df.loc[len(result_df)] = [index, 'Yes',df2.loc[index, 'MATNR'], df2.loc[index, col_name], df1.loc[index, col_name]]
                pass
            else:
