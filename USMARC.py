...
MDG = 'C:/Users/2095421/Downloads/Migration/USFood/MARC_M1P_Ext.xlsx'
ATLAS = 'C:/Users/2095421/Downloads/Migration/USFood/MARC_AAP_Ext.xlsx'
SCOPE = 'C:/Users/2095421/Downloads/Migration/USFood/Field_Scope_Data_Migration.xlsx'
DataValidationPath = 'C:/Users/2095421/Downloads/Migration/USFood/' + TABLE + '_DataValidation.xlsx'
...
def fun_cp(system_name, DataValidationPath):
...
fun_cp(MDG, DataValidationPath)
fun_cp(ATLAS, DataValidationPath)

# df1 = pd.read_excel('C:/Users/2095421/Downloads/Migration/MBEW_DataValidation.xlsx', sheet_name='MBEW_M1Q_Ext.xlsx')
df1 = pd.read_excel(DataValidationPath, sheet_name='MARC_M1P_Ext.xlsx')
# df2 = pd.read_excel('C:/Users/2095421/Downloads/Migration/MBEW_DataValidation.xlsx', sheet_name='MBEW_APB_Ext.xlsx')
df2 = pd.read_excel(DataValidationPath, sheet_name='MARC_AAP_Ext.xlsx')

df1.set_index('KEY_MARC_M1P_Ext.xlsx', inplace=True)
df2.set_index('KEY_MARC_AAP_Ext.xlsx', inplace=True)
...
for col_name in scope_field:
    print(col_name)
    if col_name != 'MATNR' and col_name != 'WERKS' :
        ...
        for index in df2.index:
            if index in df1.index:
                if df2.loc[index, col_name] == df1.loc[index, col_name] or (pd.isna(df2.loc[index, col_name]) and pd.isna(df1.loc[index, col_name])):
                    ...
                    result_df.loc[len(result_df)] = [index, 'No',df2.loc[index, 'MATNR'],df2.loc[index, 'WERKS'], df1.loc[index, col_name], df1.loc[index, col_name]]
            else:
                # print(f'Key {index}: Key not found')
                result_df.loc[len(result_df)] = [index, 'Key Not Found',df2.loc[index, 'MATNR'],df2.loc[index, 'WERKS'],'','']
